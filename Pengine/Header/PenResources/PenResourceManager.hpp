...
namespace Pengine::Resources
{
	...
	inline PenResourcesId PenResourcesManager::loadResourceFromFile(const std::filesystem::path& path)
	{
		...
		std::shared_ptr<_ResourceType> ptr = std::make_share<_ResourceType>d(m_currentId);
