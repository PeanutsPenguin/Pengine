...
namespace Pengine::Resources
{
	...
	public:
		...
		PenShaderProgramBase(const PenObjectId& id) : PenResourcesBase(id) {};
		PenShaderProgramBase(const PenShaderProgramBase& other) = default;
		PenShaderProgramBase(PenShaderProgramBase&& other) = default;
		virtual ~PenShaderProgramBase() override = default;

		PenShaderProgramBase& operator=(const PenShaderProgramBase& rhs) = default;
		PenShaderProgramBase& operator=(PenShaderProgramBase&& rhs) = default;
		...
		virtual bool	createResource(const std::string PenfilePath, std::shared_ptr<PenShaderBase> vertexShader, std::shared_ptr<PenShaderBase> fragmentShader) = 0;
