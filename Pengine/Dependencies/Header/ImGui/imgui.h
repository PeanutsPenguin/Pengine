...
// - The ClipRect/TextureBuffer/VtxOffset fields must be contiguous as we memcmp() them together (this is asserted for).
struct ImDrawCmd
{
    ...
    // Since 1.83: returns ImTextureID associated with this draw call. Warning: DO NOT assume this is always same as 'TextureBuffer' (we will change this function for an upcoming feature)
